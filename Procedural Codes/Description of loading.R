...
# We will use the drinking data as a changing covariate for a preliminary test.
...
# need to also create dyadcovariate object
...
#The default for the n3 (# of iterations in phase 3) is 1000 but for publication grade results it is advisable to use 3000

myalgorithm <- sienaAlgorithmCreate(useStdInits = FALSE, n3=3000,projname = 'WCalgInit',MaxDegree=c(friendship=10))
