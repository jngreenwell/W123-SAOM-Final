...
# in the output file.
#identify dempendent variables for the analysis
...
# The 'attribute' data (created in RscriptDataFormat.R ) is made available as a
...
# the vardyadcovar format should be somewhat similar to the sienaNet function 
# friendship=sienaNet(array(c(WC1,WC2,WC3),dim=c(numberActors,numberActors,3)))
